...
namespace ShuHai.Collections
{
    ...
    public sealed class Deque<T> : IList<T>, System.Collections.IList
    {
        ...
        /// </returns>
        bool ICollection<T>.Contains(T item) { return this.Contains(item, null); }
        ...
        /// </summary>
        private bool IsFull { get { return Count == Capacity; } }
        ...
        private int DequeIndexToBufferIndex(int index) { return (index + offset) % Capacity; }
        ...
        private T DoGetItem(int index) { return buffer[DequeIndexToBufferIndex(index)]; }
        ...
        private void DoSetItem(int index, T item) { buffer[DequeIndexToBufferIndex(index)] = item; }
